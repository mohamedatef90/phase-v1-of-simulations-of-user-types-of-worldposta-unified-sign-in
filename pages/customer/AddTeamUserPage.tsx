...
export const AddTeamUserPage: React.FC = () => {
    ...
    useEffect(() => {
        // Reset the form state when the modal is closed to avoid showing stale data.
    ...
    return (
        <>
            <Card title="Add New Team User">
                <p className="text-sm text-center text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
                    Create a new user account for a member of your team. You can assign them to a permissions group and allocate specific product resources directly to their account. This allows you to delegate management tasks while maintaining control over access levels.
                </p>
