        ...
        <div className="space-y-4">
            ...
            {isUserFormModalOpen && (
                <Modal 
                    ...
                    footer={<><Button variant="ghost" onClick={() => setIsUserFormModalOpen(false)}>Cancel</Button><Button onClick={handleSaveUser}>Save</Button></>}
                >
            ...
            {userToDelete && (
                <Modal isOpen={isDeleteUserModalOpen} onClose={() => setIsDeleteUserModalOpen(false)} title={`Delete Staff Member: ${userToDelete.fullName}`}
                    footer={<><Button variant="ghost" onClick={() => setIsDeleteUserModalOpen(false)}>Cancel</Button><Button variant="danger" onClick={handleConfirmDeleteUser} disabled={deleteUserConfirmationText !== 'DELETE'}>Delete</Button></>}>
            ...
            {groupToDelete && (
                 <Modal isOpen={isDeleteGroupModalOpen} onClose={() => setIsDeleteGroupModalOpen(false)} title={`Delete Group: ${groupToDelete.name}`}
                    footer={<><Button variant="ghost" onClick={() => setIsDeleteGroupModalOpen(false)}>Cancel</Button><Button variant="danger" onClick={handleConfirmDeleteGroup}>Delete</Button></>}>
